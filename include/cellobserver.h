...
public:
    CellObserver ( std::vector <abundance_v> &states, std::vector<double> &times, std::vector<cell_state> &vars, uint32_t store_every_n, uint32_t dump_every_n, size_t cid , const spec_v& foll, network* net);
